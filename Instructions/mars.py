...
def scrape():
    ...
    mcollection["news_title"] = soup.find('div', class_="content_title").get_text()
    mcollection["news_snip"] = soup.find('div', class_="rollover_description_inner").get_text()
    ...
    mcollection["featured_image_url"] = "https://www.jpl.nasa.gov" + pic_source[2] 
    ...
    mcollection["fact_table"] = mars_table
    ...
    mcollection["hemisphere_image"] = hemisphere_image_urls
